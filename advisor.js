...
SET_CASH_START,
SET_PROGRESS_BASIS, SET_PROGRESS_MONTHLY_GOAL, SET_PROGRESS_YEARLY_GOAL, SET_PROGRESS_YEAR_SCOPE,
CREATE_FUND, UPDATE_FUND, ARCHIVE_FUND, DELETE_FUND, ADD_SINKING_EVENT, MARK_FUND_PAID,
SHOW_DUE_SOON, SHOW_OVERDUE, SHOW_TEMPLATES, SHOW_PIGGY, SHOW_BACKUP, SHOW_SUMMARY, SHOW_PROGRESS,
EXPORT_MONTH, EXPORT_BACKUP, EXPORT_RECEIPT, GENERATE_MONTH, SET_MONTH, SET_ESSENTIALS_ONLY.
...
Progress payloads:
- SET_PROGRESS_BASIS: basis (auto|manual)
- SET_PROGRESS_MONTHLY_GOAL: amount (number >= 0)
- SET_PROGRESS_YEARLY_GOAL: amount (number >= 0)
- SET_PROGRESS_YEAR_SCOPE: year_scope (ytd|full)
INPUT:
${input}`;
    default:
